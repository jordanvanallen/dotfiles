...
let s:N3 = [s:gui_pink, s:gui_med_gray_hi, s:cterm_pink, s:cterm_med_gray_hi]
...
let g:airline#themes#bubblegum#palette.normal_modified = {
      \ 'airline_c': [s:gui_pink, s:gui_med_gray_hi, s:cterm_pink, s:cterm_med_gray_hi, ''],
      \ }
...
let g:airline#themes#bubblegum#palette.insert_paste = {
      \ 'airline_a': [s:gui_dark_gray, s:gui_pink, s:cterm_dark_gray, s:cterm_pink, ''],
      \ }

" Visual Mode
let s:V1 = [s:gui_med_gray_hi, s:gui_blue, s:cterm_med_gray_hi, s:cterm_blue]
...
let g:airline#themes#bubblegum#palette.inactive_modified = {
      \ 'airline_c': [s:gui_pink, '', s:cterm_pink, '', ''],
      \ }
...
let g:airline#themes#bubblegum#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ s:gui_pink, s:gui_med_gray_hi, s:cterm_pink, s:cterm_med_gray_hi, '' ] ,
      \ [ s:gui_pink, s:gui_med_gray_lo, s:cterm_pink, s:cterm_med_gray_lo, '' ] ,
      \ [ s:gui_dark_gray, s:gui_pink, s:cterm_dark_gray, s:cterm_pink, 'bold' ] )
